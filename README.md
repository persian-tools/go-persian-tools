...
```go
georgianDate, err := JalaaliToGregorianDate("1401/02/03") // Time.Date(2022,4,23,0,0,0,0,time.UTC)
georgianDateString, err := JalaaliToGregorian("1401/02/03") // "2022/04/23"
```
